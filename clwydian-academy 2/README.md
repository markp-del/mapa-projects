...
A fast, hand-built static website for Clwydian Academy (trading name of Charlotte Eleanor Academy C.I.C.), designed for Vercel with the custom domain **clwydianacademy.co.uk**.
...
| `CNAME` | Tells Vercel your custom domain |
...
## 2 · Publish on Vercel (15 minutes)
...
- **Change wording**: open the page's `index.html`, find the text, edit, commit. Vercel republishes automatically in ~1 minute.
